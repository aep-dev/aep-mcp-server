...
export function getPathItem(openapi: OpenAPI, path: string): PathItem | undefined {
...
export function getMethod(openapi: OpenAPI, path: string, method: string): PathItem[keyof PathItem] | undefined {
...
export function getParameters(openapi: OpenAPI, path: string, method: string): Array<{
  in: string;
  name: string;
  required: boolean;
  schema: Schema;
...
export function getRequestBody(methodInfo: PathItem[keyof PathItem]): RequestBody | undefined {
...
export function getResponses(openapi: OpenAPI, path: string, method: string): Record<string, {
  description: string;
  content?: {
    'application/json': {
      schema: Schema;
