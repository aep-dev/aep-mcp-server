...
describe('Client', () => {
  ...
  describe('create', () => {
    it('should create a resource without user specified ID', async () => {
      ...
      const result = await client.create({}, resource, baseUrl, body, parameters);
  ...
  describe('get', () => {
    it('should get a resource', async () => {
      ...
      const result = await client.get({}, baseUrl, '/publishers/my-pub/books/1');
      expect(result.path).toBe('/publishers/my-pub/books/1');
    });
  });
  ...
  describe('delete', () => {
    it('should delete a resource', async () => {
      nock(baseUrl)
        .delete('/publishers/my-pub/books/1')
        .reply(200);

      await expect(client.delete({}, baseUrl, '/publishers/my-pub/books/1')).resolves.not.toThrow();
    });
  });
  ...
  describe('update', () => {
    it('should update a resource', async () => {
      ...
      await expect(client.update({}, baseUrl, '/publishers/my-pub/books/1', body)).resolves.not.toThrow();
    });
  });
  ...
  describe('list', () => {
    it('should list resources', async () => {
      ...
      nock(baseUrl)
        ...
        .reply(200, { results: [{ path: '/publishers/my-pub/books/1', price: '2' }] });
