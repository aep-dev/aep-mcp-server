...
const openapiUrl = 'https://raw.githubusercontent.com/Roblox/creator-docs/refs/heads/main/content/en-us/reference/cloud/cloud.docs.json'
...
async function main() {
  ...
  for (const [resourceName, resource] of Object.entries(resources)) {
    server.tool(resourceName, resourceToZodSchema(resource.schema), async (args, extra) => {
      console.log(args);
      return {
